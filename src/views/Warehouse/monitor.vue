<template>
    ...
    <div class="left">
        ...
        <div style="padding: 0px 35px;">
            <div ref="trendChartRef" style="width: 398px; height: 245px;"></div>
        </div>
        ...
        <div class="ck_list">
            <div class="jcfx_box">
                ...
                <div class="jcfx_text" style="width:115px;">储备物资周转率</div>
            </div>
            <div class="jcfr_box">
        ...
        <div class="ck_list">
            <div class="jcfx_box">
                ...
                <div class="jcfx_text" style="width: 115px;">平均库存下降率</div>
            </div>
            <div class="jcfr_box">
                <div v-for="data in personnelData3.stats" :key="data.key">
                    <div class="jcfr_label">
